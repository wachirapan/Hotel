            ...
            <div class="col-md-12">
                <div class="nonloop-block-13 owl-carousel">
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_1.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_2.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_3.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_4.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_5.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="<?php echo base_url('assets/front/')?>images/img_6.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                                <h2 class="heading">VIP Room</h2>
                        ...
                        <div class="col-md-12 block-13">
                            <div class="nonloop-block-13 owl-carousel">
                                <div class="item">
                                    <div class="block-34">
                                        <div class="image">
                                            <a href="#"><img src="<?php echo base_url('assets/front/')?>images/menu_1.jpg" alt="Image placeholder"></a>
                                        </div>
                                        <div class="text">
                                ...
                                <div class="item">
                                    <div class="block-34">
                                        <div class="image">
                                            <a href="#"><img src="<?php echo base_url('assets/front/')?>images/menu_2.jpg" alt="Image placeholder"></a>
                                        </div>
                                        <div class="text">
                                ...
                                <div class="item">
                                    <div class="block-34">
                                        <div class="image">
                                            <a href="#"><img src="<?php echo base_url('assets/front/')?>images/menu_3.jpg" alt="Image placeholder"></a>
                                        </div>
                                        <div class="text">
                                ...
                                <div class="item">
                                    <div class="block-34">
                                        <div class="image">
                                            <a href="#"><img src="<?php echo base_url('assets/front/')?>images/menu_4.jpg" alt="Image placeholder"></a>
                                        </div>
                                        <div class="text">
...
<div class="block-30 block-30-sm item" style="background-image: url('<?php echo base_url('assets/front/')?>images/bg_2.jpg');" data-stellar-background-ratio="0.5">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="<?php echo base_url('assets/front/')?>images/person_3.jpg" alt="Person here"></div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="<?php echo base_url('assets/front/')?>images/person_2.jpg" alt="Person here"></div>
                        <div class="name-text align-self-center">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="<?php echo base_url('assets/front/')?>images/person_1.jpg" alt="Person here"></div>
                        <div class="name-text align-self-center">
